    ...
    <div class="IBReport">
        <el-card class="box-card">
                ...
                <el-row :gutter="15">
                    <el-col :span="24" class="header">
                        <el-col :span="6">
                            ...
                            <span>&nbsp;{{$t('indexLang.ibReport')}}</span>
                        </el-col>
            ...
            <div v-loading="loading">
                <client-list :rootData="tableData" @current-page="tablePageChange" @page-size="handleSizeChange" :pTableTotal="total" v-if="status" :pCurrentPage="current_page" :pPageSize="page_size"></client-list>
            </div>
        </el-card>
    </div>
</template>
...
import { getIBData } from "@/api/report/report";
    ...
    methods: {
        ...
        getUserList(){
            ...
            if(this.reportDate && this.reportDate.length > 0){
				params.start_time_format = this.reportDate[0];
				params.end_time_format = this.reportDate[1];
			}
            console.log(params);
            this.loading = true;
            this.tableData = [];
            getIBData(params).then( data => {
                console.log(data);
                this.loading = false;
