<template>
	<div class="clientList" :class="{tableHeight: isExist,tabHeight: !isExist}" v-loading="loading">
		<el-table :data="tableData" style="width: 100%" @expand-change="changeExpand" stripe row-class-name="iconStyle" border ref="clientList" :height="userTableHeight">
	...
	data() {
		return {
			...
			tableHead: [
				...
				{ propName: '',labelName: this.$t('table.countAcc'),width: '100' },
...
<style>
.clientList .el-table th{
	background: rgb(223, 240, 216);
}
.clientList .el-table__expanded-cell[class*=cell]{
	padding: 10px 20px;
}
</style>
